...
:
(
	{ before(grammarAccess.getFileAccess().getDefineKeyword_0()); }
	'define'
	{ after(grammarAccess.getFileAccess().getDefineKeyword_0()); }
)
;
finally {
	restoreStackSize(stackSize);
...
:
(
	{ before(grammarAccess.getFileAccess().getBodyAssignment_2()); }
	(rule__File__BodyAssignment_2)
	{ after(grammarAccess.getFileAccess().getBodyAssignment_2()); }
)
;
finally {
	restoreStackSize(stackSize);
...
:
	(
		{ before(grammarAccess.getFileAccess().getBodyXBlockExpressionParserRuleCall_2_0()); }
		ruleXBlockExpression
		{ after(grammarAccess.getFileAccess().getBodyXBlockExpressionParserRuleCall_2_0()); }
	)
;
finally {
	restoreStackSize(stackSize);
