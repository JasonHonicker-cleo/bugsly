 ...
 */
package x.buglang.ide.contentassist.antlr;
...
import x.buglang.ide.contentassist.antlr.internal.InternalBugslyParser;
import x.buglang.services.BugslyGrammarAccess;

public class BugslyParser extends AbstractContentAssistParser {
	...
	@Override
	protected InternalBugslyParser createParser() {
		InternalBugslyParser result = new InternalBugslyParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getFileAccess().getBodyAssignment_2(), "rule__File__BodyAssignment_2");
