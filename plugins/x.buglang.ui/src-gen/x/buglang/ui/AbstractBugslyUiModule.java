...
import x.buglang.ide.contentassist.antlr.PartialBugslyContentAssistParser;
import x.buglang.ide.contentassist.antlr.internal.InternalBugslyLexer;
import x.buglang.ui.contentassist.BugslyProposalProvider;
import x.buglang.ui.labeling.BugslyDescriptionLabelProvider;
import x.buglang.ui.labeling.BugslyLabelProvider;
import x.buglang.ui.outline.BugslyOutlineTreeProvider;
import x.buglang.ui.quickfix.BugslyQuickfixProvider;

/**
 * Manual modifications go to {@link BugslyUiModule}.
 */
@SuppressWarnings("all")
public abstract class AbstractBugslyUiModule extends DefaultXbaseWithAnnotationsUiModule {

	public AbstractBugslyUiModule(AbstractUIPlugin plugin) {
		super(plugin);
	}
	...
	public void configureHighlightingLexer(Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class)
			...
			.to(x.buglang.parser.antlr.internal.InternalBugslyLexer.class);
	}
	...
	public void configureContentAssistLexerProvider(Binder binder) {
		binder.bind(InternalBugslyLexer.class).toProvider(LexerProvider.create(InternalBugslyLexer.class));
	}
	...
	public Class<? extends ILabelProvider> bindILabelProvider() {
		return BugslyLabelProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.labeling.LabelProviderFragment2
	public void configureResourceUIServiceLabelProvider(Binder binder) {
		binder.bind(ILabelProvider.class).annotatedWith(ResourceServiceDescriptionLabelProvider.class).to(BugslyDescriptionLabelProvider.class);
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.outline.OutlineTreeProviderFragment2
	public Class<? extends IOutlineTreeProvider> bindIOutlineTreeProvider() {
		return BugslyOutlineTreeProvider.class;
	}
	...
	public Class<? extends IssueResolutionProvider> bindIssueResolutionProvider() {
		return BugslyQuickfixProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.contentAssist.ContentAssistFragment2
	public Class<? extends IContentProposalProvider> bindIContentProposalProvider() {
		return BugslyProposalProvider.class;
	}
	...
	public Class<? extends IPartialEditingContentAssistParser> bindIPartialEditingContentAssistParser() {
		return PartialBugslyContentAssistParser.class;
	}
	...
	public void configureCompareViewerTitle(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(UIBindings.COMPARE_VIEWER_TITLE)).toInstance("Bugsly Compare");
	}
