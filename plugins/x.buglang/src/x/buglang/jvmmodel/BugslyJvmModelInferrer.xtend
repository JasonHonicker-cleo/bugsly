 ...
 */
class BugslyJvmModelInferrer extends AbstractModelInferrer {
	 ...
	 *            <code>true</code>.
	 */
	def dispatch void infer(File element, IJvmDeclaredTypeAcceptor acceptor, boolean isPreIndexingPhase) {
