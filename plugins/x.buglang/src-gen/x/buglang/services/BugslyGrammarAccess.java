...
@Singleton
public class BugslyGrammarAccess extends AbstractGrammarElementFinder {
	
	public class FileElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "x.buglang.Bugsly.File");
		...
		//File:
		//	'define' name=ID body=XBlockExpression;
	...
	@Inject
	public BugslyGrammarAccess(GrammarProvider grammarProvider,
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("x.buglang.Bugsly".equals(grammar.getName())) {
				return grammar;
			}
