...
public class BugslySemanticSequencer extends XbaseWithAnnotationsSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == BugslyPackage.eINSTANCE)
			switch (semanticObject.eClass().getClassifierID()) {
			case BugslyPackage.FILE:
	 ...
	 *
	 * Constraint:
	 *     (name=ID body=XBlockExpression)
	 */
	protected void sequence_File(ISerializationContext context, File semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, BugslyPackage.Literals.FILE__NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, BugslyPackage.Literals.FILE__NAME));
			if (transientValues.isValueTransient(semanticObject, BugslyPackage.Literals.FILE__BODY) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, BugslyPackage.Literals.FILE__BODY));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getFileAccess().getNameIDTerminalRuleCall_1_0(), semanticObject.getName());
		feeder.accept(grammarAccess.getFileAccess().getBodyXBlockExpressionParserRuleCall_2_0(), semanticObject.getBody());
		feeder.finish();
	}
