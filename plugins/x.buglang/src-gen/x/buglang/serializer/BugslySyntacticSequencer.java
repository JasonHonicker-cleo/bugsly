...
public class BugslySyntacticSequencer extends AbstractSyntacticSequencer {

	protected BugslyGrammarAccess grammarAccess;
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (BugslyGrammarAccess) access;
